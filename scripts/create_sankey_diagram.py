...
def main():
    ...
    output_file = '/home/asadr/works/repos/survey-ai-cwf/scripts/sankey_diagram.html'
    fig.write_html(output_file, post_script=[js_code])
    print(f"\nSankey diagram saved to: {output_file}")
    
    # Also save as PNG
    png_file = '/home/asadr/works/repos/survey-ai-cwf/scripts/sankey_diagram.png'
    fig.write_image(png_file, width=FIG_SIZE[0], height=FIG_SIZE[1])
    print(f"Sankey diagram saved as PNG to: {png_file}")
    
    # Also save as SVG
    svg_file = '/home/asadr/works/repos/survey-ai-cwf/scripts/sankey_diagram.svg'
